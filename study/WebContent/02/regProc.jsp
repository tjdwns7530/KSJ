...
<%@ page import="kr.or.nextit.function.MemberUtil" %>
    ...
    <%
	  //response.setCharacterEncoding("UTF-8");
	  	...
	  	String name = "입력되지않았습니다.";
	  	String sex = "입력되지않았습니다.";
	  	int age = -1;
    try{
...
취미 2 : <%
			...
			for(String ho : hobby){
				//out.println(ho);
				for(HashMap<String, Object> item : MemberUtil.getDisplayHobbyList()){
...
%>
	...
	나이 1 : <%=displayAge(age)%><br>
	성별 2 : <%=MemberUtil.getDisplayAge(age) %>
	<pre>
	<%
